...
\section{Experience}
\cventry{2026--Present}{Invited Reviewer}{IEEE RA-L}{}{}{
Peer review of multiple Nonholonomic Motion and Path Planning manuscripts
}
\cventry{2026--Present}{Research Fellowship}{University of Trento}{}{}{
Study of Wake-Up Radios for Energy-Neutral Systems.
}
...
\begin{itemize}
    \item Robotics: Developed a novel polyline smoothing algorithm for robot path planning, leading to a publication in IEEE RA-L.
...
\href{https://www.enssys.org/2026/programme.php}{Energy–Latency Characterization of an Integrated
Wake-Up Radio SoC} \\
\textbf{P. Pastorelli}, D. Brunelli, and M. Nardello.\\
ENSsys 2026.\\
\small{\textit{To Appear}}
\end{minipage}
}
\cvitem{2025}{
\begin{minipage}[t]{0.85\textwidth}
\href{https://doi.org/10.1109/SENSORS59705.2025.11330908}{Every Microjoule Counts: Zero-Failure Task Execution in Batteryless Sensors} \\
